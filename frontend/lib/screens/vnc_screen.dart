...
import '../widgets/vnc_widget.dart';
...
class _VncScreenState extends ConsumerState<VncScreen> {
  ...
  Future<void> _loadAuthFromLocalStorage() async {
    ...
    final storedToken = html.window.localStorage['vnc_auth_token'];
    final storedUser = html.window.localStorage['vnc_auth_user'];
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // VNC widget with dark container
            Expanded(
              child: Container(
